...
public class TestCloudBackupRestore extends SolrCloudTestCase {
  ...
  public void test() throws Exception {
    ...
    CollectionAdminRequest.Create create = new CollectionAdminRequest.Create();
        //collectionName, "conf1", NUM_SHARDS, replFactor);
    ...
    if (!isImplicit && random().nextBoolean()) {
      ...
      CollectionAdminRequest.SplitShard splitShard = new CollectionAdminRequest.SplitShard().setCollectionName(collectionName);
